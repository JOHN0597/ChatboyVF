...
public class ChatRVAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType){
            ...
            case 1:
                ...
                return new UserViewHolder.BotViewHolder(view);
        }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        switch (chatsModal.getSender()){
            ...
            case "user":
                ( (UserViewHolder)holder).useTV.setText(chatsModal.getMessage());
                break;
            case "bot":
                ((UserViewHolder.BotViewHolder)holder).botMsgTV.setText(chatsModal.getMessage());
                break;
    ...
    public static class UserViewHolder extends RecyclerView.ViewHolder {
        ...
        public UserViewHolder(@NonNull View itemView) {
            ...
            useTV = itemView.findViewById(R.id.idTVUser);
